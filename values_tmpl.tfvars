...
## Host settings
tenant                      = "Trustinfo" # Компания владелец
cluster_name                = "pve-cluster" # Кластер виртуализации в нетбоксе
...
## Network settings
network_int                 = "vmbr0" # Виртуальный интерфейс для подключения вм к сети
network                     = "10.10.0" #Подсеть вм. Указывается без последнего октета
ip_address                  = "last octet" # Ip адрес виртуальной машины. Последний октет в адресе
mask                        = "/24" # Префикс маски подсети
